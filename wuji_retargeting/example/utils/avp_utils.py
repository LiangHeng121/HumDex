...
if TYPE_CHECKING:  # pragma: no cover
    from wuji_retargeting.retarget import WujiHandRetargeter, RetargetingResult
...
def retarget_vision_pro(
    hand_matrices: np.ndarray,
    hand_side: str = "right",
    retargeter: Optional["WujiHandRetargeter"] = None,
) -> "RetargetingResult":
    """
    ...
    if retargeter is None:
        if hand_side not in _retargeter_cache:
            # Lazy import (requires Pinocchio)
            from wuji_retargeting.retarget import WujiHandRetargeter
